...
gulp.task('watch', function() {
    ...
    watch('src/**/*.@(js|jsx)', options, function() {
        return runSequence('js');
    });

    watch('src/**/*.scss', options, function() {
        return runSequence('buildSass');
    });

    watch('static/images/**/*', options, function() {
        return runSequence('minifyImages');
    });

    watch('static/fonts/**/*', options, function() {
        return runSequence('copyFonts');
    });

    watch('locale/**/*', options, function() {
